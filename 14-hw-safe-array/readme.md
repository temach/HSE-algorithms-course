Проект №3: Защищенный массив
============================

## Задание

Задание к настоящему проекту представлено в виде стартовой страницы doxygen-документации: [index.html][index_html].
...
* `/res/raw` — каталог с «необработанными» («сырыми») ресурсами;
* `/tests` — тесты
...
[index_html]: docs/doxydoc/out/html/index.html